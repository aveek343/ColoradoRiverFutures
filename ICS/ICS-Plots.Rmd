...
This is an R Markdown document. This stacked bar chart compares account balances by state and year for the Intentionally Created Surplus program for Lake Mead to the max balance allowed by the 2007 Interim Guidelines. 
